...
export const config={matcher:['/','/app/:path*','/login','/auth/:path*','/book/:path*','/api/workspace','/api/integrations','/api/availability/:path*','/api/calendar/sync','/api/public-links','/api/public/:path*']};
